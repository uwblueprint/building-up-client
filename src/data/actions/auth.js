import { REGISTER_SUCCESS, REGISTER_FAIL, LOGIN_SUCCESS, LOGIN_FAIL, LOGOUT_FAIL, LOGOUT_SUCCESS, GET_TEAM_SUCCESS, GET_TEAM_FAIL } from './type';
  ...
  return AuthService.getCurrentUser(client).then(
    res => {
      if (res.data.getActiveUser !== null) {
        ...
        console.log(res.data.getActiveUser);
