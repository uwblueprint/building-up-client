  ...
  return (
    <div>
      ...
      <form onSubmit={handleClick}>
        <div>
          <input name="firstName" placeholder="firstName" value={firstName} onChange={onChangeFirstName} />
        </div>
        <div>
          <input name="lastName" placeholder="lastName" value={lastName} onChange={onChangeLastName} />
        </div>
        <div>
